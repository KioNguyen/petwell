...
const useRudderStackAnalytics = ():
    ...
    if (!analytics) {
      const initialize = async () => {
        ...
        initializationPromise = (async () => {
          const writeKey = "2zWvzPlrqT3qTcKq11XjhR1Vi1K";
          const dataplaneUrl =
  ...
  `);
          ...
          analyticsInstance.page("Home Page"); // Example of auto tracking a page view
        ...
        const instance = await initializationPromise;
        if (instance) {
          instance.page("Home Page"); // Example of auto tracking a page view
          setAnalytics(instance);
        }
      };
